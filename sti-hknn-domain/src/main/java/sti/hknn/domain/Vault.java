...
public class Vault {
    ...
    public static Teacher teacher1 = new Teacher("Kisslo", "Shek", "1234", courseList, 450);
    public static Teacher teacher2 = new Teacher("Özgür", "Kibar", "4567", courseList, 600);
    public static Teacher teacher3 = new Teacher("Mikael", "Wallin", "7890", courseList, 550);
